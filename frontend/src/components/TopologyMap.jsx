...
import { Network, Server, Database, CloudLightning } from 'lucide-react';

export function TopologyMap({ anomalyStates, activeIncident }) {
  ...
  // Line dash animation speeds (dashoffset animation)
